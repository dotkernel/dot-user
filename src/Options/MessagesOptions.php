...
class MessagesOptions extends AbstractOptions
{
    ...
    const MESSAGE_LOGIN_PASSWORD_CHARACTER_LIMIT = 9;
    ...
    const MESSAGE_RESET_PASSWORD_PASSWORD_CHARACTER_LIMIT = 18;
    const MESSAGE_RESET_PASSWORD_EMPTY_PASSWORD_VERIFY = 19;
    const MESSAGE_RESET_PASSWORD_PASSWORD_MISMATCH = 20;
    ...
    const MESSAGE_REGISTER_USERNAME_CHARACTER_LIMIT = 32;
    ...
    const MESSAGE_REGISTER_PASSWORD_CHARACTER_LIMIT = 36;
    const MESSAGE_REGISTER_EMPTY_PASSWORD_CONFIRM = 37;
    const MESSAGE_REGISTER_PASSWORD_MISMATCH = 38;
    ...
    const MESSAGE_CHANGE_PASSWORD_EMPTY_PASSWORD = 45;
    const MESSAGE_CHANGE_PASSWORD_EMPTY_NEW_PASSWORD = 46;
    const MESSAGE_CHANGE_PASSWORD_NEW_PASSWORD_CHARACTER_LIMIT = 47;
    const MESSAGE_CHANGE_PASSWORD_EMPTY_PASSWORD_VERIFY = 48;
    const MESSAGE_CHANGE_PASSWORD_PASSWORD_MISMATCH = 49;
    ...
    protected $messages = [
        ...
        MessagesOptions::MESSAGE_LOGIN_PASSWORD_CHARACTER_LIMIT => 'Password must have at least 4 to 255 characters',
        ...
        MessagesOptions::MESSAGE_RESET_PASSWORD_PASSWORD_CHARACTER_LIMIT => 'Password must have at least 4 to 255 characters',
        ...
        MessagesOptions::MESSAGE_REGISTER_USERNAME_CHARACTER_LIMIT => 'Username must have at least 3 to 255 characters',
        ...
        MessagesOptions::MESSAGE_REGISTER_PASSWORD_CHARACTER_LIMIT => 'Password must have at least 4 to 255 characters',
        ...
        MessagesOptions::MESSAGE_CHANGE_PASSWORD_NEW_PASSWORD_CHARACTER_LIMIT => 'New password must have at least 4 to 255 characters',
